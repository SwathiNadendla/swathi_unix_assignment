...
This documentation should be clear and easy to follow. Specifically, please include:
...
**Repository Name**: Please include "BCB546-Spring2025" in the name of your repository.

### In-Class Presentation:

Each group will have ~20 minutes to present their work on either May 7th or May 9th.  Each presentation should include:
...
The deadline for forming groups is **March 5th, 2025**. When you have formed your group, _post your group name and list of members_ on the Slack `#final-project` channel. 
...
**The deadline for submitting your repository on Canvas is May 9th, 2025.**
